...
$LNG['user_limit'] = 'Terlalu banyak akun yang dibuat dari IP ini';
...
$LNG['login'] = 'Masuk';
$LNG['connect'] = 'Connect';
$LNG['password'] = 'kata sandi';
$LNG['username'] = 'Username';
$LNG['email'] = 'Email';
$LNG['captcha'] = 'Captcha';
$LNG['username_or_email'] = 'Username atau email';
$LNG['welcome_title'] = 'Selamat Datang';
$LNG['welcome_desc'] = 'di facebook duplikat';
$LNG['welcome_about'] = 'Bagikan kenanganmu, terhubung dengan orang lain, dapatkan teman baru.';
$LNG['forgot_password'] = 'Lupa kata sandi?';
$LNG['remember_me'] = 'Ingat saya';
$LNG['all_rights_reserved'] = 'All rights reserved';

$LNG['welcome_one'] = 'Connect';
$LNG['welcome_two'] = 'Share';
$LNG['welcome_three'] = 'Discover';
$LNG['welcome_one_desc'] = 'Terhubung dengan keluarga dan teman Anda dan bagikan momen Anda';
$LNG['welcome_two_desc'] = 'Bagikan momen hidup dan baru dengan teman-teman Anda';
$LNG['welcome_three_desc'] = 'Temukan orang baru, buat koneksi baru, dan dapatkan teman baru';
$LNG['latest_users'] = 'Pengguna terbaru';

// NOTIFICATION BOXES
$LNG['settings_saved'] = 'Pengaturan Disimpan';
$LNG['nothing_saved'] = 'Tidak ada yang Tersimpan';
$LNG['password_changed'] = 'Kata Sandi Berubah';
$LNG['nothing_changed'] = 'Tidak ada yang berubah';
$LNG['incorrect_date'] = 'Tanggal yang dipilih tidak valid, pilih tanggal yang valid.';
$LNG['password_not_changed'] = 'Kata sandi tidak diubah.';
$LNG['image_saved'] = 'Gambar Disimpan';
$LNG['error'] = 'Error';
$LNG['no_file'] = 'Anda tidak memilih file apa pun untuk diunggah, atau file yang dipilih kosong.';
$LNG['file_exceeded'] = 'Ukuran file yang dipilih tidak boleh melebihi <strong>%s</strong> MB.';
$LNG['file_format'] = 'Format file yang dipilih tidak didukung. Unggah <strong>%s</strong> file format';
$LNG['image_removed'] = 'Gambar Dihapus';
$LNG['bio_description'] = 'Deskripsi Biografi harus terdiri dari% s karakter atau kurang.';
...
$LNG['profile_blocked'] = 'Sorry, but you have blocked or been blocked by this user.';$ LNG ['profile_blocked_ttl'] = 'Profil diblokir';
$ LNG ['add_friend'] = 'Tambahkan sebagai teman';
$ LNG ['remove_friend'] = 'Hapus teman';
$ LNG ['friend_request_sent'] = 'Permintaan pertemanan terkirim';
$ LNG ['friend_request_accept'] = 'Terima permintaan pertemanan';
$ LNG ['create_on'] = 'Dibuat pada';
$ LNG ['description'] = 'Description';
$ LNG ['profile_about'] = 'Tentang';
$ LNG ['profile_birthdate'] = 'Tanggal lahir';
$ LNG ['Lifes_in'] = 'Tinggal di';
$ LNG ['born_on'] = 'Lahir pada';
$ LNG ['learn_at'] = 'Belajar di';
$ LNG ['works_at'] = 'Bekerja di';
$ LNG ['profile_view_site'] = 'Lihat situs web';
$ LNG ['profile_view_profile'] = 'Lihat Profil';
$ LNG ['profile_bio'] = 'Bio';
$ LNG ['Verified_page'] = 'Halaman Terverifikasi';
$ LNG ['edit_profile_cover'] = 'Ubah Gambar Profil';
$ LNG ['view_all_notifications'] = 'Lihat Lebih Banyak Pemberitahuan';
$ LNG ['view_chat_notifications'] = 'Lihat Lebih Banyak Pesan';
$ LNG ['view_confirmed_friendships'] = 'Tampilkan permintaan yang dikonfirmasi';
...
$ LNG ['no_results'] = 'Tidak ada hasil yang tersedia. Coba pencarian lain. ';
$ LNG ['no_results_ttl'] = 'Hasil Pencarian';
$ LNG ['search_for_users'] = 'Cari pengguna';
$ LNG ['search_in_friends'] = 'Cari di teman';
$ LNG ['type_message'] = 'Ketik pesan ...';
$ LNG ['follow'] = 'Follows';
$ LNG ['follow_by'] = 'Diikuti oleh';
$ LNG ['orang'] = 'orang';
$ LNG ['no_info_avail'] = 'Tidak ada informasi yang tersedia';
$ LNG ['account_suspended'] = 'Account ini sedang ditangguhkan.';
$ LNG ['account_not_activated'] = 'Akun ini tidak diaktifkan. <a href="%s"> Klik di sini </a> untuk mengirim ulang email aktivasi. ';
$ LNG ['re_activate_already'] = 'Email aktivasi telah dikirim hari ini';
$ LNG ['re_activate_sent'] = 'Email aktivasi telah dikirim';


// UMUM
$ LNG ['title_profile'] = 'Profil';
$ LNG ['title_feed'] = 'Umpan Berita';
$ LNG ['title_post'] = 'Posting';
$ LNG ['title_messages'] = 'Pesan';
$ LNG ['title_settings'] = 'Pengaturan';
$ LNG ['title_search'] = 'Cari';
$ LNG ['title_notifications'] = 'Pemberitahuan';
$ LNG ['title_page'] = 'Buat Halaman';
$ LNG ['title_group'] = 'Buat Grup';
$ LNG ['title_admin'] = 'Admin';
$ LNG ['edit'] = 'Edit';
$ LNG ['delete'] = 'Hapus';
$ LNG ['ditangguhkan'] = 'Ditangguhkan';
$ LNG ['ignore'] = 'Abaikan';
$ LNG ['view'] = 'View';
$ LNG ['garis waktu'] = 'Garis waktu';
$ LNG ['on'] = 'On';
$ LNG ['off'] = 'Off';
$ LNG ['yes'] = 'Yes';
$ LNG ['no'] = 'No';
$ LNG ['none'] = 'None';
$ LNG ['halaman'] = 'Halaman';
$ LNG ['search_for_people'] = 'cari orang, #hashtags';
$ LNG ['search_pages'] = ', @pages';
$ LNG ['search_groups'] = ',! Groups';
$ LNG ['new_message'] = 'Pesan baru';
$ LNG ['privacy_policy'] = 'Kebijakan Privasi';
$ LNG ['terms_of_use'] = 'Ketentuan Penggunaan';
$ LNG ['about'] = 'About';
$ LNG ['disclaimer'] = 'Disclaimer';
$ LNG ['contact'] = 'Kontak';
$ LNG ['developer'] = 'Pengembang';
$ LNG ['language'] = 'Language';

// WAKTU
$ LNG ['just_now'] = 'baru saja';
$ LNG ['ta_second'] = 'satu detik';
$ LNG ['ta_seconds'] = '% d detik';
$ LNG ['ta_minute'] = 'satu menit';
$ LNG ['ta_minutes'] = '% d menit';
$ LNG ['ta_hour'] = 'satu jam';
$ LNG ['ta_hours'] = '% d jam';
$ LNG ['ta_day'] = 'a day';
$ LNG ['ta_days'] = '% d hari';
$ LNG ['ta_week'] = 'seminggu';
$ LNG ['ta_weeks'] = '% d minggu';
$ LNG ['ta_month'] = 'satu bulan';
$ LNG ['ta_months'] = '% d bulan';
$ LNG ['ta_year'] = 'satu tahun';
$ LNG ['ta_years'] = '% d tahun';
$ LNG ['lalu'] = 'lalu';
